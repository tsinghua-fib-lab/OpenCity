...
__all__ = ["AppHubClient", "AgentMessage", "UserMessage", "Waypoint"]

def _image2base64(image: Image.Image) -> str:
    buffered = BytesIO()
...
class AppHubClient:
    ...
    def _bind(self, foreign_id: int | None, type: str, name: str, avatar: Image.Image) -> int:
        if foreign_id == None:
            foreign_id_ = -1
        else:
    ...
    def bind_person(self, person_id: int, name: str, avatar: Image.Image):
        """
    ...
    def bind_org(self, org_id: int, name: str, avatar: Image.Image):
        """
    ...
    def bind_func(self, name:str, avatar:Image.Image):
        """
